...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-lg font-bold text-gray-900">GreenHouse</span>
          </div>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
          ...
          <div className="space-y-6 md:space-y-8 order-2 lg:order-1">
            ...
            <div className="flex flex-col space-y-3 md:flex-row md:space-y-0 md:space-x-4">
              <Link 
                href="/auth/signup" 
                className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-4 md:px-8 md:py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center min-h-[44px] flex items-center justify-center"
              >
                Start Free Trial
              </Link>
              <Link 
                href="/dashboard/admin" 
                className="border-2 border-green-500 text-green-600 px-6 py-4 md:px-8 md:py-4 rounded-xl font-semibold hover:bg-green-50 transition-all duration-300 text-center min-h-[44px] flex items-center justify-center"
              >
                View Demo
              </Link>
            </div>
            ...
            <div className="flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-6 text-sm text-gray-500">
              <div className="flex items-center space-x-2">
          ...
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl p-4 md:p-8 shadow-xl">
              <div className="grid grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-6">
                <div className="bg-white rounded-xl p-3 md:p-4 shadow-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs md:text-sm text-gray-600">Temperature</span>
                    <span className="text-green-600 font-semibold text-sm md:text-base">24°C</span>
                  </div>
                ...
                <div className="bg-white rounded-xl p-3 md:p-4 shadow-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs md:text-sm text-gray-600">Humidity</span>
                    <span className="text-blue-600 font-semibold text-sm md:text-base">68%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                ...
                <div className="bg-white rounded-xl p-3 md:p-4 shadow-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs md:text-sm text-gray-600">Light</span>
                    <span className="text-yellow-600 font-semibold text-sm md:text-base">85%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                ...
                <div className="bg-white rounded-xl p-3 md:p-4 shadow-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs md:text-sm text-gray-600">CO2</span>
                    <span className="text-purple-600 font-semibold text-sm md:text-base">420ppm</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
              ...
              <div className="bg-white rounded-xl p-3 md:p-4 shadow-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs md:text-sm text-gray-600">System Status</span>
                  <span className="text-green-600 font-semibold text-sm md:text-base">Optimal</span>
                </div>
      ...
      <section id="features" className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Real-time Monitoring</h3>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Automated Controls</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Smart Alerts</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Analytics & Reports</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Mobile Access</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-4">Team Management</h3>
            <p className="text-gray-600 text-sm md:text-base">
      ...
      {/* Mobile-Optimized Install App Section */}
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 rounded-2xl md:rounded-3xl p-8 md:p-12 text-center text-white">
      ...
      <section className="container mx-auto px-4 py-12 md:py-20">
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl md:rounded-3xl p-8 md:p-12 text-center text-white">
          <h2 className="text-2xl md:text-4xl font-bold mb-4">
          ...
          <div className="flex flex-col space-y-3 md:flex-row md:space-y-0 md:space-x-4 justify-center">
            <Link 
              href="/auth/signup" 
              className="bg-white text-green-600 px-6 py-4 md:px-8 md:py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105 text-center min-h-[44px] flex items-center justify-center"
            >
              Start Free Trial
            </Link>
            <Link 
              href="/dashboard/admin" 
              className="border-2 border-white text-white px-6 py-4 md:px-8 md:py-4 rounded-xl font-semibold hover:bg-white hover:text-green-600 transition-all duration-300 text-center min-h-[44px] flex items-center justify-center"
            >
              Schedule Demo
            </Link>
          </div>
      ...
      {/* Desktop-Only Footer (Hidden on Mobile per PWA Best Practices) */}
